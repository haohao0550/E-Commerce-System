...
export class ProductVariantsService {
  constructor(private readonly productVariantsRepo: IProductVariantsRepo = new ProductVariantsRepo()) {}
  ...
  private async ensureColorSizeNotExists(productId: string, color?: string | null, size?: string | null) {
    const variant = await this.productVariantsRepo.findByProductColorSize(productId, color, size)
