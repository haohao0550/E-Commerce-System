...
export class CartController {
	...
	async updateCartItemByVariant(req: Request, res: Response, next: NextFunction) {
		const { userId } = req.user;
		const { variantId } = req.params;
		const item = await this.cartService.updateCartItemByVariant(userId, variantId.toString(), req.body);
	...
	async deleteCartItemByVariant(req: Request, res: Response, next: NextFunction) {
		const { userId } = req.user;
		const { variantId } = req.params;
		await this.cartService.deleteCartItemByVariant(userId, variantId.toString());
	...
	async syncCart(req: Request, res: Response, next: NextFunction) {
		const { userId } = req.user;
		const result = await this.cartService.syncCart(userId, req.body);
	...
	async applyCoupon(req: Request, res: Response, next: NextFunction) {
		const { userId } = req.user;
		const result = await this.cartService.applyCoupon(userId, req.body);
	...
	async removeCoupon(req: Request, res: Response, next: NextFunction) {
		const { userId } = req.user;
		await this.cartService.removeCoupon(userId);
