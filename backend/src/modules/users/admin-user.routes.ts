...
router.get('/', validateQuery(getUsersQuerySchema), asyncHandler(userController.getUsers));

router.get('/:id', validateParams(userIdParamSchema), asyncHandler(userController.getUserById));
