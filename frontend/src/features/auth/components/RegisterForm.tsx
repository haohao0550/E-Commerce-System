...
export const RegisterForm = () => {
  ...
  return (
    <form className="auth-form" onSubmit={handleSubmit}>
      <Input label="Name" name="name" type="text" minLength={2} autoComplete="name" />
      <Input label="Phone" name="phone" type="tel" placeholder="0912345678" inputMode="numeric" autoComplete="tel" />
